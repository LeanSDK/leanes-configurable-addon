...
// You should have received a copy of the GNU Lesser General Public License
// along with leanes-configurable-addon.  If not, see <https://www.gnu.org/licenses/>.
var ConfigurableInterface = flowRuntime_umd.type("ConfigurableInterface", flowRuntime_umd.object(flowRuntime_umd.property("_configurableI", flowRuntime_umd.string("ConfigurableInterface"))));
...
var Configuration = (function (Module) {
  ...
  var Configuration = (_dec = flowRuntime_umd.annotate(flowRuntime_umd["class"]("Configuration", flowRuntime_umd["extends"](Proxy), flowRuntime_umd.staticProperty("__filename", flowRuntime_umd.any()), flowRuntime_umd.staticProperty("object", flowRuntime_umd.any()), flowRuntime_umd.property("_configI", flowRuntime_umd.any()), flowRuntime_umd.method("root", flowRuntime_umd["return"](flowRuntime_umd.string())), flowRuntime_umd.method("environment", flowRuntime_umd["return"](flowRuntime_umd.string())), flowRuntime_umd.property("_name", flowRuntime_umd.nullable(flowRuntime_umd.string())), flowRuntime_umd.property("_description", flowRuntime_umd.nullable(flowRuntime_umd.string())), flowRuntime_umd.property("_license", flowRuntime_umd.nullable(flowRuntime_umd.string())), flowRuntime_umd.property("_version", flowRuntime_umd.nullable(flowRuntime_umd.string())), flowRuntime_umd.property("_keywords", flowRuntime_umd.nullable(flowRuntime_umd.array(flowRuntime_umd.string()))), flowRuntime_umd.method("constructor", flowRuntime_umd.param("args", flowRuntime_umd.any())), flowRuntime_umd.method("name", flowRuntime_umd["return"](flowRuntime_umd.nullable(flowRuntime_umd.string()))), flowRuntime_umd.method("description", flowRuntime_umd["return"](flowRuntime_umd.nullable(flowRuntime_umd.string()))), flowRuntime_umd.method("license", flowRuntime_umd["return"](flowRuntime_umd.nullable(flowRuntime_umd.string()))), flowRuntime_umd.method("version", flowRuntime_umd["return"](flowRuntime_umd.nullable(flowRuntime_umd.string()))), flowRuntime_umd.method("keywords", flowRuntime_umd["return"](flowRuntime_umd.nullable(flowRuntime_umd.array(flowRuntime_umd.string())))), flowRuntime_umd.method("manifestPath", flowRuntime_umd["return"](flowRuntime_umd.string())), flowRuntime_umd.method("configPath", flowRuntime_umd["return"](flowRuntime_umd.string())), flowRuntime_umd.method("defineConfigProperties"), flowRuntime_umd.method("onRegister", flowRuntime_umd.param("args", flowRuntime_umd.any())))), _dec2 = partOf(Module), _dec3 = flowRuntime_umd.decorate(flowRuntime_umd.nullable(flowRuntime_umd.string())), _dec4 = flowRuntime_umd.decorate(flowRuntime_umd.nullable(flowRuntime_umd.string())), _dec5 = flowRuntime_umd.decorate(flowRuntime_umd.nullable(flowRuntime_umd.string())), _dec6 = flowRuntime_umd.decorate(flowRuntime_umd.nullable(flowRuntime_umd.string())), _dec7 = flowRuntime_umd.decorate(flowRuntime_umd.nullable(flowRuntime_umd.array(flowRuntime_umd.string()))), _dec(_class = initialize(_class = _dec2(_class = (_class2 = (_temp = _class3 = /*#__PURE__*/function (_Proxy) {
    ...
    createClass(Configuration, [{
      ...
      get: function get() {
        ...
        return _returnType.assert(this.getData() || '.');
      }
    }, {
      key: "environment",
      get: function get() {
        ...
        if (ENV === 'production') {
          return _returnType2.assert(PRODUCTION);
        } else {
          return _returnType2.assert(DEVELOPMENT);
        }
      }
    }]);
    ...
    function Configuration() {
      ...
      initializerDefineProperty(_this, "_configI", _descriptor, assertThisInitialized(_this));

      initializerDefineProperty(_this, "_name", _descriptor2, assertThisInitialized(_this));

      initializerDefineProperty(_this, "_description", _descriptor3, assertThisInitialized(_this));

      initializerDefineProperty(_this, "_license", _descriptor4, assertThisInitialized(_this));

      initializerDefineProperty(_this, "_version", _descriptor5, assertThisInitialized(_this));

      initializerDefineProperty(_this, "_keywords", _descriptor6, assertThisInitialized(_this));

      flowRuntime_umd.ref(ConfigurationInterface$1).assert(assertThisInitialized(_this));
      return _this;
    }
    ...
    createClass(Configuration, [{
        ...
        for (var key in configs) {
          ...
          (function (attr, config) {
            ...
            switch (config.type) {
              ...
              case 'json':
                assert(_.isString(config["default"]) || _.isPlainObject(config["default"]), "Default for '".concat(attr, "' must be JSON string or js object"));
      ...
      value: function onRegister() {
        ...
        (_get2 = get(getPrototypeOf(Configuration.prototype), "onRegister", this)).call.apply(_get2, [this].concat(args));
      ...
      get: function get() {
        ...
        return _returnType4.assert(this._description);
      }
    }, {
      key: "license",
      get: function get() {
        var _returnType5 = flowRuntime_umd["return"](flowRuntime_umd.nullable(flowRuntime_umd.string()));

        return _returnType5.assert(this._license);
      }
    }, {
      key: "version",
      get: function get() {
        var _returnType6 = flowRuntime_umd["return"](flowRuntime_umd.nullable(flowRuntime_umd.string()));

        return _returnType6.assert(this._version);
      }
    }, {
      key: "keywords",
      get: function get() {
        var _returnType7 = flowRuntime_umd["return"](flowRuntime_umd.nullable(flowRuntime_umd.array(flowRuntime_umd.string())));

        return _returnType7.assert(this._keywords);
      }
    }, {
      key: "manifestPath",
      get: function get() {
        ...
        return _returnType8.assert('package.json');
      }
    }, {
      key: "configPath",
      get: function get() {
        var _returnType9 = flowRuntime_umd["return"](flowRuntime_umd.string());

        return _returnType9.assert("configs/".concat(this.environment));
      }
    }]);

    return Configuration;
  }(Proxy), _class3.__filename = __filename$1, _class3.object = {}, _temp), (applyDecoratedDescriptor(_class2, "__filename", [nameBy], (_init = Object.getOwnPropertyDescriptor(_class2, "__filename"), _init = _init ? _init.value : undefined, {
    enumerable: true,
    configurable: true,
    writable: true,
  ...
  }), _class2), _descriptor = applyDecoratedDescriptor(_class2.prototype, "_configI", [property], {
    configurable: true,
    enumerable: true,
    writable: true,
    initializer: function initializer() {
  ...
  }), applyDecoratedDescriptor(_class2.prototype, "root", [property], Object.getOwnPropertyDescriptor(_class2.prototype, "root"), _class2.prototype), applyDecoratedDescriptor(_class2.prototype, "environment", [property], Object.getOwnPropertyDescriptor(_class2.prototype, "environment"), _class2.prototype), _descriptor2 = applyDecoratedDescriptor(_class2.prototype, "_name", [_dec3, property], {
    configurable: true,
    enumerable: true,
    writable: true,
    initializer: function initializer() {
  ...
  }), _descriptor3 = applyDecoratedDescriptor(_class2.prototype, "_description", [_dec4, property], {
    configurable: true,
    enumerable: true,
    writable: true,
    initializer: function initializer() {
  ...
  }), _descriptor4 = applyDecoratedDescriptor(_class2.prototype, "_license", [_dec5, property], {
    configurable: true,
    enumerable: true,
    writable: true,
    initializer: function initializer() {
  ...
  }), _descriptor5 = applyDecoratedDescriptor(_class2.prototype, "_version", [_dec6, property], {
    configurable: true,
    enumerable: true,
    writable: true,
    initializer: function initializer() {
  ...
  }), _descriptor6 = applyDecoratedDescriptor(_class2.prototype, "_keywords", [_dec7, property], {
    configurable: true,
    enumerable: true,
    writable: true,
    initializer: function initializer() {
  ...
  }), applyDecoratedDescriptor(_class2.prototype, "name", [property], Object.getOwnPropertyDescriptor(_class2.prototype, "name"), _class2.prototype), applyDecoratedDescriptor(_class2.prototype, "description", [property], Object.getOwnPropertyDescriptor(_class2.prototype, "description"), _class2.prototype), applyDecoratedDescriptor(_class2.prototype, "license", [property], Object.getOwnPropertyDescriptor(_class2.prototype, "license"), _class2.prototype), applyDecoratedDescriptor(_class2.prototype, "version", [property], Object.getOwnPropertyDescriptor(_class2.prototype, "version"), _class2.prototype), applyDecoratedDescriptor(_class2.prototype, "keywords", [property], Object.getOwnPropertyDescriptor(_class2.prototype, "keywords"), _class2.prototype), applyDecoratedDescriptor(_class2.prototype, "manifestPath", [property], Object.getOwnPropertyDescriptor(_class2.prototype, "manifestPath"), _class2.prototype), applyDecoratedDescriptor(_class2.prototype, "configPath", [property], Object.getOwnPropertyDescriptor(_class2.prototype, "configPath"), _class2.prototype), applyDecoratedDescriptor(_class2.prototype, "defineConfigProperties", [method], Object.getOwnPropertyDescriptor(_class2.prototype, "defineConfigProperties"), _class2.prototype), applyDecoratedDescriptor(_class2.prototype, "onRegister", [method], Object.getOwnPropertyDescriptor(_class2.prototype, "onRegister"), _class2.prototype)), _class2)) || _class) || _class) || _class);
});
...
var ConfigurableInterface$1 = flowRuntime_umd.tdz(function () {
  return ConfigurableInterface;
});
var ConfigurationInterface$2 = flowRuntime_umd.tdz(function () {
  return ConfigurationInterface;
});
var ConfigurableMixin = (function (Module) {
  var _Module$NS = Module.NS,
  ...
  Module.defineMixin(__filename$2, function (BaseClass) {
    ...
    var Mixin = (_dec = flowRuntime_umd.annotate(flowRuntime_umd["class"]("Mixin", flowRuntime_umd["extends"](BaseClass), flowRuntime_umd.staticProperty("object", flowRuntime_umd.any()), flowRuntime_umd.property("_configurableI", flowRuntime_umd.any()), flowRuntime_umd.property("_configurationFactory", flowRuntime_umd["function"](function (_fn) {
      var T = _fn.typeParameter("T", undefined, flowRuntime_umd.ref(ConfigurationInterface$2));

      return [flowRuntime_umd["return"](flowRuntime_umd.object(flowRuntime_umd.property("_configI", flowRuntime_umd.$propertyType(flowRuntime_umd.flowInto(T), flowRuntime_umd.string("_configI")))))];
    })), flowRuntime_umd.method("constructor", flowRuntime_umd.param("args", flowRuntime_umd.any())), flowRuntime_umd.method("configs", function (_fn2) {
      var T = _fn2.typeParameter("T", undefined, flowRuntime_umd.ref(ConfigurationInterface$2));

      return [flowRuntime_umd["return"](flowRuntime_umd.object(flowRuntime_umd.property("_configI", flowRuntime_umd.$propertyType(T, flowRuntime_umd.string("_configI")))))];
    }))), _dec2 = flowRuntime_umd.decorate(flowRuntime_umd["function"](function (_fn3) {
      var T = _fn3.typeParameter("T", undefined, flowRuntime_umd.ref(ConfigurationInterface$2));

      return [flowRuntime_umd["return"](flowRuntime_umd.object(flowRuntime_umd.property("_configI", flowRuntime_umd.$propertyType(flowRuntime_umd.flowInto(T), flowRuntime_umd.string("_configI")))))];
    })), _dec3 = inject("Factory<".concat(CONFIGURATION, ">")), _dec(_class = initializeMixin(_class = (_class2 = (_temp = _class3 = /*#__PURE__*/function (_BaseClass) {
      ...
      function Mixin() {
        ...
        initializerDefineProperty(_this, "_configurableI", _descriptor, assertThisInitialized(_this));

        initializerDefineProperty(_this, "_configurationFactory", _descriptor2, assertThisInitialized(_this));

        flowRuntime_umd.ref(ConfigurableInterface$1).assert(assertThisInitialized(_this));
        return _this;
      }
      ...
      createClass(Mixin, [{
        key: "configs",
        get: function get() {
          var T = flowRuntime_umd.typeParameter("T", undefined, flowRuntime_umd.ref(ConfigurationInterface$2));

          var _returnType = flowRuntime_umd["return"](flowRuntime_umd.object(flowRuntime_umd.property("_configI", flowRuntime_umd.$propertyType(T, flowRuntime_umd.string("_configI")))));
    ...
    }), _class2), _descriptor = applyDecoratedDescriptor(_class2.prototype, "_configurableI", [property], {
      configurable: true,
      enumerable: true,
      writable: true,
      initializer: function initializer() {
    ...
    }), _descriptor2 = applyDecoratedDescriptor(_class2.prototype, "_configurationFactory", [_dec2, _dec3, property], {
      configurable: true,
      enumerable: true,
      writable: true,
      initializer: null
    }), applyDecoratedDescriptor(_class2.prototype, "configs", [property], Object.getOwnPropertyDescriptor(_class2.prototype, "configs"), _class2.prototype)), _class2)) || _class) || _class);
    return Mixin;
  });
});
...
var MemoryConfigurationMixin = (function (Module) {
  var _Module$NS = Module.NS,
      assert = _Module$NS.assert,
      initializeMixin = _Module$NS.initializeMixin,
      meta = _Module$NS.meta,
  ...
  Module.defineMixin(__filename$3, function (BaseClass) {
    ...
    var Mixin = (_dec = flowRuntime_umd.annotate(flowRuntime_umd["class"]("Mixin", flowRuntime_umd["extends"](BaseClass), flowRuntime_umd.staticProperty("object", flowRuntime_umd.any()), flowRuntime_umd.method("root", flowRuntime_umd["return"](flowRuntime_umd.string())), flowRuntime_umd.method("defineConfigProperties"))), _dec(_class = initializeMixin(_class = (_class2 = (_temp = _class3 = /*#__PURE__*/function (_BaseClass) {
      ...
      createClass(Mixin, [{
        ...
        get: function get() {
          ...
          return _returnType.assert(this.Module.prototype.ROOT || '.');
        }
      }]);
    ...
    }), _class2), applyDecoratedDescriptor(_class2.prototype, "root", [property], Object.getOwnPropertyDescriptor(_class2.prototype, "root"), _class2.prototype), applyDecoratedDescriptor(_class2.prototype, "defineConfigProperties", [method], Object.getOwnPropertyDescriptor(_class2.prototype, "defineConfigProperties"), _class2.prototype)), _class2)) || _class) || _class);
    return Mixin;
  });
});

var __filename$4 = '/mixins/ConfigurableFacadeMixin.js';
...
// You should have received a copy of the GNU Lesser General Public License
// along with leanes-configurable-addon.  If not, see <https://www.gnu.org/licenses/>.
var ConfigurableFacadeMixin = (function (Module) {
  var _Module$NS = Module.NS,
      CONFIGURATION = _Module$NS.CONFIGURATION,
      initializeMixin = _Module$NS.initializeMixin,
      meta = _Module$NS.meta,
...
var index = (function (Module) {
  ...
  return ['ConfigurableAddon', function (BaseClass) {
    ...
    var Mixin = (_dec = flowRuntime_umd.annotate(flowRuntime_umd["class"]("Mixin", flowRuntime_umd["extends"](BaseClass), flowRuntime_umd.staticProperty("object", flowRuntime_umd.any()), flowRuntime_umd.property("CONFIGURATION", flowRuntime_umd.any()))), _dec2 = extend('ConfigurableFacadeMixin', 'Facade'), _dec(_class = _dec2(_class = ConfigurableFacadeMixin(_class = MemoryConfigurationMixin(_class = ConfigurableMixin(_class = Configuration(_class = initializeMixin(_class = (_class2 = (_temp = _class3 = /*#__PURE__*/function (_BaseClass) {
      inherits(Mixin, _BaseClass);
      ...
      function Mixin() {
        ...
        initializerDefineProperty(_this, "CONFIGURATION", _descriptor, assertThisInitialized(_this));
    ...
    }), _class2), _descriptor = applyDecoratedDescriptor(_class2.prototype, "CONFIGURATION", [constant], {
      configurable: true,
      enumerable: true,
      writable: true,
      initializer: function initializer() {
...
exports.ConfigurableInterface = ConfigurableInterface;
