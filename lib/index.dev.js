...
var ConfigurationTF = (function (Module) {
  ...
  var Configuration = (_dec = flowRuntime_umd.annotate(flowRuntime_umd["class"]("Configuration", flowRuntime_umd["extends"](Proxy), flowRuntime_umd.staticProperty("__filename", flowRuntime_umd.any()), flowRuntime_umd.staticProperty("object", flowRuntime_umd.any()), flowRuntime_umd.property("_configI", flowRuntime_umd.any()), flowRuntime_umd.method("root", flowRuntime_umd["return"](flowRuntime_umd.string())), flowRuntime_umd.method("environment", flowRuntime_umd["return"](flowRuntime_umd.string())), flowRuntime_umd.property("_name", flowRuntime_umd.nullable(flowRuntime_umd.string())), flowRuntime_umd.property("_description", flowRuntime_umd.nullable(flowRuntime_umd.string())), flowRuntime_umd.property("_license", flowRuntime_umd.nullable(flowRuntime_umd.string())), flowRuntime_umd.property("_version", flowRuntime_umd.nullable(flowRuntime_umd.string())), flowRuntime_umd.property("_keywords", flowRuntime_umd.nullable(flowRuntime_umd.array(flowRuntime_umd.string()))), flowRuntime_umd.method("constructor", flowRuntime_umd.param("args", flowRuntime_umd.any())), flowRuntime_umd.method("name", flowRuntime_umd["return"](flowRuntime_umd.nullable(flowRuntime_umd.string()))), flowRuntime_umd.method("description", flowRuntime_umd["return"](flowRuntime_umd.nullable(flowRuntime_umd.string()))), flowRuntime_umd.method("license", flowRuntime_umd["return"](flowRuntime_umd.nullable(flowRuntime_umd.string()))), flowRuntime_umd.method("version", flowRuntime_umd["return"](flowRuntime_umd.nullable(flowRuntime_umd.string()))), flowRuntime_umd.method("keywords", flowRuntime_umd["return"](flowRuntime_umd.nullable(flowRuntime_umd.array(flowRuntime_umd.string())))), flowRuntime_umd.method("manifestPath", flowRuntime_umd["return"](flowRuntime_umd.string())), flowRuntime_umd.method("configPath", flowRuntime_umd["return"](flowRuntime_umd.string())), flowRuntime_umd.method("defineConfigProperties"), flowRuntime_umd.method("onRegister", flowRuntime_umd.param("args", flowRuntime_umd.any())))), _dec2 = partOf(Module), _dec3 = flowRuntime_umd.decorate(flowRuntime_umd.nullable(flowRuntime_umd.string())), _dec4 = flowRuntime_umd.decorate(flowRuntime_umd.nullable(flowRuntime_umd.string())), _dec5 = flowRuntime_umd.decorate(flowRuntime_umd.nullable(flowRuntime_umd.string())), _dec6 = flowRuntime_umd.decorate(flowRuntime_umd.nullable(flowRuntime_umd.string())), _dec7 = flowRuntime_umd.decorate(flowRuntime_umd.nullable(flowRuntime_umd.array(flowRuntime_umd.string()))), _dec(_class = initialize(_class = _dec2(_class = (_class2 = (_temp = _class3 = /*#__PURE__*/function (_Proxy) {
    ...
    function Configuration() {
      ...
      flowRuntime_umd.ref(ConfigurationInterface$1).assert(_assertThisInitialized(_this));
      return _this;
    }
    ...
    _createClass(Configuration, [{
      ...
      get: function get() {
        ...
        return _returnType8.assert('manifest.json');
      }
    }, {
      key: "configPath",
      get: function get() {
  ...
  }), _applyDecoratedDescriptor(_class2.prototype, "root", [property], Object.getOwnPropertyDescriptor(_class2.prototype, "root"), _class2.prototype), _applyDecoratedDescriptor(_class2.prototype, "environment", [property], Object.getOwnPropertyDescriptor(_class2.prototype, "environment"), _class2.prototype), _descriptor2 = _applyDecoratedDescriptor(_class2.prototype, "_name", [_dec3, property], {
    configurable: true,
    enumerable: true,
    writable: true,
    initializer: function initializer() {
  ...
  }), _descriptor3 = _applyDecoratedDescriptor(_class2.prototype, "_description", [_dec4, property], {
    configurable: true,
    enumerable: true,
    writable: true,
    initializer: function initializer() {
  ...
  }), _descriptor4 = _applyDecoratedDescriptor(_class2.prototype, "_license", [_dec5, property], {
    configurable: true,
    enumerable: true,
    writable: true,
    initializer: function initializer() {
  ...
  }), _descriptor5 = _applyDecoratedDescriptor(_class2.prototype, "_version", [_dec6, property], {
    configurable: true,
    enumerable: true,
    writable: true,
    initializer: function initializer() {
  ...
  }), _descriptor6 = _applyDecoratedDescriptor(_class2.prototype, "_keywords", [_dec7, property], {
    configurable: true,
    enumerable: true,
    writable: true,
    initializer: function initializer() {
...
var ConfigurableMixinTF = (function (Module) {
  ...
  Module.defineMixin(__filename$2, flowRuntime_umd.annotate(function (BaseClass) {
    ...
    var Mixin = (_dec = flowRuntime_umd.annotate(flowRuntime_umd["class"]("Mixin", flowRuntime_umd["extends"](BaseClass), flowRuntime_umd.staticProperty("object", flowRuntime_umd.any()), flowRuntime_umd.property("_configurableI", flowRuntime_umd.any()), flowRuntime_umd.property("_configurationFactory", flowRuntime_umd["function"](function (_fn3) {
    ...
    })), flowRuntime_umd.method("constructor", flowRuntime_umd.param("args", flowRuntime_umd.any())), flowRuntime_umd.method("configs", function (_fn4) {
      var T = _fn4.typeParameter("T", undefined, flowRuntime_umd.ref(ConfigurationInterface$2));
    ...
    }))), _dec2 = flowRuntime_umd.annotate(flowRuntime_umd["class"]("Mixin", flowRuntime_umd["extends"](BaseClass), flowRuntime_umd.staticProperty("object", flowRuntime_umd.any()), flowRuntime_umd.property("_configurableI", flowRuntime_umd.any()), flowRuntime_umd.property("_configurationFactory", flowRuntime_umd["function"](function (_fn) {
      ...
      var T = _fn5.typeParameter("T", undefined, flowRuntime_umd.ref(ConfigurationInterface$2));

      return [flowRuntime_umd["return"](flowRuntime_umd.object(flowRuntime_umd.property("_configI", flowRuntime_umd.$propertyType(flowRuntime_umd.flowInto(T), flowRuntime_umd.string("_configI")))))];
    })), _dec4 = inject("Factory<".concat(CONFIGURATION, ">")), _dec(_class = _dec2(_class = initializeMixin(_class = (_class2 = (_temp = _class3 = /*#__PURE__*/function (_BaseClass) {
      ...
      function Mixin() {
        ...
        flowRuntime_umd.ref(ConfigurableInterface$1).assert(_assertThisInitialized(_this));
        return _this;
      }
    ...
    }), _descriptor2 = _applyDecoratedDescriptor(_class2.prototype, "_configurationFactory", [_dec3, _dec4, property], {
      configurable: true,
      enumerable: true,
      writable: true,
      initializer: null
    }), _applyDecoratedDescriptor(_class2.prototype, "configs", [property], Object.getOwnPropertyDescriptor(_class2.prototype, "configs"), _class2.prototype)), _class2)) || _class) || _class) || _class);
    return Mixin;
...
var MemoryConfigurationMixinTF = (function (Module) {
  var _Module$NS = Module.NS,
      ...
      _ = _Module$NS$Utils._,
      assign = _Module$NS$Utils.assign;
  Module.defineMixin(__filename$3, flowRuntime_umd.annotate(function (BaseClass) {
    var _dec, _dec2, _class, _class2, _init, _class3, _temp;

    var _BaseClassType = flowRuntime_umd.Class(flowRuntime_umd.ref(Configuration));

    flowRuntime_umd.param("BaseClass", _BaseClassType).assert(BaseClass);
    var Mixin = (_dec = flowRuntime_umd.annotate(flowRuntime_umd["class"]("Mixin", flowRuntime_umd["extends"](BaseClass), flowRuntime_umd.staticProperty("object", flowRuntime_umd.any()), flowRuntime_umd.method("root", flowRuntime_umd["return"](flowRuntime_umd.string())), flowRuntime_umd.method("defineConfigProperties"))), _dec2 = flowRuntime_umd.annotate(flowRuntime_umd["class"]("Mixin", flowRuntime_umd["extends"](BaseClass), flowRuntime_umd.staticProperty("object", flowRuntime_umd.any()), flowRuntime_umd.method("root", flowRuntime_umd["return"](flowRuntime_umd.string())), flowRuntime_umd.method("defineConfigProperties"))), _dec(_class = _dec2(_class = initializeMixin(_class = (_class2 = (_temp = _class3 = /*#__PURE__*/function (_BaseClass) {
      _inherits(Mixin, _BaseClass);
    ...
    }), _class2), _applyDecoratedDescriptor(_class2.prototype, "root", [property], Object.getOwnPropertyDescriptor(_class2.prototype, "root"), _class2.prototype), _applyDecoratedDescriptor(_class2.prototype, "defineConfigProperties", [method], Object.getOwnPropertyDescriptor(_class2.prototype, "defineConfigProperties"), _class2.prototype)), _class2)) || _class) || _class) || _class);
    return Mixin;
  }, flowRuntime_umd["function"](flowRuntime_umd.param("BaseClass", flowRuntime_umd.Class(flowRuntime_umd.ref(Configuration))))));
});
...
var index = (function (Module) {
  ...
  return ['ConfigurableAddon', flowRuntime_umd.annotate(function (BaseClass) {
    ...
    flowRuntime_umd.param("BaseClass", _BaseClassType).assert(BaseClass);
    var Mixin = (_dec = flowRuntime_umd.annotate(flowRuntime_umd["class"]("Mixin", flowRuntime_umd["extends"](BaseClass), flowRuntime_umd.staticProperty("object", flowRuntime_umd.any()), flowRuntime_umd.property("CONFIGURATION", flowRuntime_umd.any()), flowRuntime_umd.staticMethod("including"))), _dec2 = flowRuntime_umd.annotate(flowRuntime_umd["class"]("Mixin", flowRuntime_umd["extends"](BaseClass), flowRuntime_umd.staticProperty("object", flowRuntime_umd.any()), flowRuntime_umd.property("CONFIGURATION", flowRuntime_umd.any()), flowRuntime_umd.staticMethod("including"))), _dec(_class = _dec2(_class = initializeMixin(_class = (_class2 = (_temp = _class3 = /*#__PURE__*/function (_BaseClass) {
      _inherits(Mixin, _BaseClass);
