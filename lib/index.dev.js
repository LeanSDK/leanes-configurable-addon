...
var index = (function (Module) {
  ...
  return ['ConfigurableAddon', function (BaseClass) {
    ...
    var Mixin = (_dec = flowRuntime_umd.annotate(flowRuntime_umd["class"]("Mixin", flowRuntime_umd["extends"](BaseClass), flowRuntime_umd.staticProperty("object", flowRuntime_umd.any()), flowRuntime_umd.property("CONFIGURATION", flowRuntime_umd.any()), flowRuntime_umd.staticMethod("including"))), _dec(_class = FacadePatchTF(_class = MemoryConfigurationMixinTF(_class = ConfigurableMixinTF(_class = ConfigurationTF(_class = initializeMixin(_class = (_class2 = (_temp = _class3 = /*#__PURE__*/function (_BaseClass) {
      _inherits(Mixin, _BaseClass);
    ...
    }), _applyDecoratedDescriptor(_class2, "including", [method], Object.getOwnPropertyDescriptor(_class2, "including"), _class2)), _class2)) || _class) || _class) || _class) || _class) || _class) || _class);
    return Mixin;
  }];
});
